;(()=>{try{const e=new URL(window.location.href);if(e.hostname==="0.0.0.0"){e.hostname="127.0.0.1",console.warn("检测到访问地址为 0.0.0.0，已自动切换为 "+e.origin+"（避免浏览器兼容性问题）"),window.location.replace(e.toString())}}catch(e){}})();
let config=null
