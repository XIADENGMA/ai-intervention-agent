...
- ⏱️ **倒计时延长** —— 一键 `+60s` 按钮，让你需要多想一会儿时不必慌张；外加 ❄️ **永久冻结** 按钮，让你真正需要暂时离开时直接关停自动重调，回来再继续
