...
>
> This repository adopts [Contributor Covenant 2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/) verbatim.  The Chinese translation is provided for convenience; the English text governs in case of conflict.
...
- **GitHub**: [@xiadengma](https://github.com/xiadengma)
- **Private Vulnerability Reporting** (for behavior tied to a security incident):
  https://github.com/xiadengma/ai-intervention-agent/security/advisories/new
